...
export type UnifiedBalance = { available: bigint; pending: bigint | undefined; total: bigint | undefined; sources: ReadonlyArray<{ domain: number; chain: string; amount: bigint }> };
