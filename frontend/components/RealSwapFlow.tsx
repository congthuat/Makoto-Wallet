...
type Props = { locale: "en" | "vi"; initialValues?: { amount?: string; asset?: SupportedAssetId; outputAsset?: SupportedAssetId; origin?: "agent" }; onBusyChange(busy: boolean): void; onConfirmed?(result?: { hash: Hex; amount: bigint; asset: SupportedAssetId; outputAmount: bigint; outputAsset: SupportedAssetId }): void };
