...
export function AppShell({ children, guardianSetupJarId, legacyClassName }: { children: ReactNode; guardianSetupJarId?: bigint; legacyClassName?: string }) {
  ...
  return <div className={`${styles.page} ${legacyClassName ?? ""}`.trim()}>
    ...
    <AppHeader guardianSetupJarId={guardianSetupJarId} />
