...
import { handoffUrl, prepareAgentActionHandoff, validateAgentActionDraft } from "@/lib/agent/actions";
...
function ActionDraftCard({ draft, vi }: { draft: AgentActionDraft; vi: boolean }) {
  ...
  function prepare() { const prepared = prepareAgentActionHandoff(draft); if (prepared.handoff) window.location.assign(handoffUrl(prepared.handoff)); }
